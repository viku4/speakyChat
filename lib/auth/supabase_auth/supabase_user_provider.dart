...
//
// class SpeakyChatSupabaseUser extends BaseAuthUser {
//   SpeakyChatSupabaseUser(this.user);
//   User? user;
...
// Stream<BaseAuthUser> speakyChatSupabaseUserStream() {
...
//       .map<BaseAuthUser>(
//     (authState) {
//       currentUser = SpeakyChatSupabaseUser(authState?.session?.user);
//       return currentUser!;
//     },
//   );
// }
